                ...
                <div className="text-content">
                    <div className="informatie_container">
                        ...
                        <div>
                            ...
                            {!isAuth ? (
                                <button className="bttn bttn_small" onClick={() => { window.location.href = "/SignIn"; }}>Inloggen</button>
                            ) : (
                                <button className="bttn bttn_small" onClick={() => { logout(); window.location.href = "/"; }}>Uitloggen</button>
                            )}
                        </div>
                    </div>
                </div>
                <Cubes button_1="Hoe maak je bier"
