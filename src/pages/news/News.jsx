...
import TextComponent from "../../components/textcomponents/TextComponent.jsx";
            ...
            <div className="outer_news_Container">
                ...
                <div className="text-component">
                    <div className="border_top_left  background">
                        ...
                        />
                        <img className="news_Img" src={Bierkroket} alt="foto van bierkroketen"/>
                    </div>
                </div>
                <div className="text-component background_fade2">
                    <div className="border_top_left background2">
                        ...
                        <TextComponent
                            ...
                            Text_Message1={[
                                "2 december 2023",
                                <p key="link"><a href="https://www.houseofbird.nl/kwintelooijen/" target="_blank"
                                                 rel="noopener noreferrer">www.houseofbird.nl</a></p>
                            ]}
                        />
                        ...
                        <TextComponent
                            ...
                            Text_Message1={["... december 2023",
                                <p key="link"><a href="https://localhost:5173/home" target="_blank"
                                                 rel="noopener noreferrer">www.beersandbrewskys.nl</a></p>]}
                        />
                        <CarouselComponent src1={logo_small} alt1="logo BenB" src2={Orloff}
                                           alt2="Cakfe Orloff Utrecht"/>
                    </div>
                </div>
            </div>
        </>
